    ...
    def parse(ssml_text: str, default_params: Dict[str, Any]) -> List[Dict[str, Any]]:
        try:
                ...
                for child in element:
                    ...
                    if child.tag == "break":
                        ...
                        if level in ["strong", "moderate"]:
                            ...
                            child_params["repetition_penalty"] = (
                                child_params.get("repetition_penalty", 2.0) * 1.2
                            )
            ...
            if not segments:
                ...
                return [
                    {"type": "text", "content": clean_text, "params": default_params}
                ]
            ...
            logger.warning(
                f"SSML Parse Error: {e}. Falling back to plain text regex clean."
            )
